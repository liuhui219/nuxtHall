...
export const commonStructors /*: INetPackTemplateCommonDataSet*/ = {
    CMD_MB_Common_Query: [{t: "uint32_t", k: "userID"}],
    ...
    CMD_MB_PlaceOrderResult: [{t: "utf8", k: "msg", s: 1024}],
};
...
export const sendStructors: INetPackTemplateDataSet = {
    [commands.MDM_MB_LOGON]: {
        ...
        [commands.SUB_MB_GetScoreInfo]: [{t: "uint32_t", k: "userID"}],
    },
};
...
export const structors: INetPackTemplateDataSet = {
    [commands.MDM_MB_LOGON]: {
        ...
        [commands.SUB_MB_LOGON_EXIT]: [{t: "uint32_t", k: "userID"}],
        ...
        [commands.SUB_MB_RESET_LOGON_PASSWORD_RESULT]: [{t: "uint32_t", k: "errorCode"}],
    ...
    [commands.MDM_MB_SERVER_LIST]: {
        ...
        [commands.SUB_MB_C_GET_SERVER_LIST]: [{t: "uint16_t", k: "kindID"}],
        ...
        [commands.SUB_MB_S_SERVER_LIST]: [
            {
                t: [
                    {t: "uint16_t", k: "kindID"},
                    {t: "uint16_t", k: "sortID"},
                    {t: "uint16_t", k: "serverID"},
                    {t: "uint16_t", k: "serverKind"},
                    {t: "uint16_t", k: "serverType"},
                    {t: "int64_t", k: "cellScore"},
                    {t: "int64_t", k: "enterScore"},
                    {t: "uint32_t", k: "onLineCount"},
                    {t: "uint32_t", k: "androidCount"},
                    {t: "uint32_t", k: "fullCount"},
                    {t: "uint16_t", k: "tableCount"},
                ],
                k: "items",
            },
        ],
    ...
    [commands.MDM_GP_USER_SERVICE]: {
        ...
        [commands.SUB_MB_CheckInLoadConfig_RESULT]: [
            {
                t: [
                    {t: "int64_t", k: "rewardGold", s: lengths.LEN_WEEK},
                    {
                        ...
                        k: "serialCheckInReward",
                        s: lengths.MAX_SERAIL_CHECK_IN_COUNT,
                    },
                ],
                k: "items",
                s: lengths.MAX_GROW_COUNT,
        ...
        [commands.SUB_MB_CheckInGetUserStatus]: [{t: "uint32_t", k: "userID"}],
                ...
                t: [
                    {
                        ...
                        k: "items",
                        s: lengths.MAX_ITEM_COUNT,
                    },
                ],
                k: "lotterys",
                s: lengths.MAX_LOTTERY_COUNT,
            },
        ],
        ...
        [commands.SUB_MB_BindMobile]: [
            {t: "uint32_t", k: "userID"},
            {t: "char16_t", k: "dynamicPass", s: lengths.LEN_PASSWORD},
            {t: "char16_t", k: "mobile", s: 20},
            {t: "char16_t", k: "logonPass", s: lengths.LEN_PASSWORD},
            {t: "char16_t", k: "checkCode", s: lengths.LEN_MOBILE_CHECKCODE},
            {t: "char16_t", k: "clientIP", s: lengths.LEN_IP},
        ],
        ...
        [commands.SUB_MB_QueryOrderStatusBatch_RESULT]: [
            ...
            {t: "uint16_t", k: "count"},
            {
                ...
                k: "items",
                s: lengths.MAX_BATCH_ORDER_QUERY,
            },
        ],
        ...
        [commands.SUB_MB_GetMobiles_RESULT]: [{t: "utf8", k: "mobiles", s: [45, lengths.LEN_INTERNATIONAL_MOBILE]}],
        ...
        [commands.SUB_MB_ShareLotteryGetWithdrawStage_RESULT]: [
            {t: "uint16_t", k: "count"},
            {
                ...
                k: "items",
                s: lengths.SHARE_LOTTERY_STAGE_COUNT,
            },
        ],
        ...
        [commands.SUB_MB_ShareLotteryTakeSpreadRebate_RESULT]: [{t: "int64_t", k: "score"}],
        ...
        [commands.SUB_MB_SharePayRebateLoadConfig_RESULT]: [{t: "uint32_t", k: "value", s: 2}],
        ...
        [commands.SUB_GP_TASK_LIST_EX_RESULT]: [
            ...
            {t: "uint32_t", k: "count"},
            {
                t: [
                    {t: "int32_t", k: "taskID"},
                    {t: "int32_t", k: "taskType"},
                    {t: "int32_t", k: "taskStatus"},
                    {t: "int64_t", k: "taskCurProgress"},
                    {t: "int64_t", k: "taskMaxProgress"},
                    {t: "uint16_t", k: "taskOperationType"},
                    {t: "uint16_t", k: "taskOperationSubType"},
                    {t: "uint16_t", k: "rewardType"},
                    {t: "int64_t", k: "rewardValue"},
                    {t: "int32_t", k: "gameKindID"},
                    {t: "char16_t", k: "taskDesc", s: 128},
                ],
                k: "items",
                s: 0,
            },
        ...
        [commands.SUB_MB_GetTaskActivenessConfig_RESULT]: [
            ...
            {
                t: [
                    {t: "uint32_t", k: "configID"},
                    {t: "uint32_t", k: "activeness"},
                    {t: "uint8_t", k: "rewardType"},
                    {t: "int64_t", k: "rewardValue"},
                ],
                k: "items",
                s: 0,
        ...
        [commands.SUB_MB_GetUserTaskActivenessStatus_RESULT]: [
            ...
            {t: "uint16_t", k: "count"},
            {
                ...
                k: "items",
                s: lengths.MAX_TASK_ACTIVENESS_COUNT,
            },
        ],
        ...
        [commands.SUB_MB_AlmzLoadConfig_RESULT]: [{t: "uint16_t", k: "items", s: lengths.MAX_GROW_COUNT}],
        ...
        [commands.SUB_MB_ExperienceScoreGetUserStatus_RESULT]: [{t: "int32_t", k: "experienceRestCount"}],
    ...
    [commands.MDM_GP_CHAT]: {
        ...
        [commands.SUB_MAIL_Detail_RESULT]: [
            ...
            {t: "time_t", k: "timestamp"},
            {
                ...
                k: "attachments",
                s: lengths.MAX_MAIL_ATTACHMENT_COUNT,
            },
            {t: "utf8", k: "title", s: lengths.LEN_MAIL_TITLE},
        ...
        [commands.SUB_MAIL_GetNewMailCount]: [{t: "uint32_t", k: "userID"}],
        // 获取新邮件数量:接收(51,113) CMD_S_GetNewMailCount
        [commands.SUB_MAIL_GetNewMailCount_RESULT]: [{t: "uint8_t", k: "count"}],
    },
};
