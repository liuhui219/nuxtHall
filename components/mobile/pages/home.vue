...
<template>
    <div class="mobile-home-container w-full" ref="homeContainer">
            ...
            <div class="container-banner w-full">
                ...
                <div v-if="list.length > 1" class="home-nl-p">
                    <div
                        ...
                        :key="item"
                        :class="{'home-nl-p-a': index === activeIndex}"
                    >
          ...
          >
            ...
            <section class="game-classification mt-[20px] w-full" v-for="(item, index) in tabList" :key="index">
                ...
                <div>
                    ...
                    >
                        <swiper-slide
                            v-for="count in Math.ceil(item.children.length / 2)"
                            :key="count"
        ...
        <client-only>
            <LazyMobilePagesDraggable
                :callBackFn="vipChargeFn"
                initialX="10"
                initialY="310"
                spines
                spineName="xiagnzi"
            ...
            <LazyMobilePagesDraggable
                ...
                spineName="lihe"
            />
            <LazyMobilePagesDraggable :callBackFn="checkInFn" initialX="10" initialY="170" img="qiandao" />
            <LazyMobilePagesDraggable :callBackFn="firstChargeFn" img="feiji" />
        </client-only>
    </div>
</template>
